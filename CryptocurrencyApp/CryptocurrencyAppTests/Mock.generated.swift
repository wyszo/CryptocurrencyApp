...
open class RouterProtocolMock: RouterProtocol, Mock {
    ...
    open func presentCryptocurrencyDetailViewController(_ cryptocurrency: Cryptocurrency) {
        addInvocation(.m_presentCryptocurrencyDetailViewController__cryptocurrency(Parameter<Cryptocurrency>.value(`cryptocurrency`)))
		let perform = methodPerformValue(.m_presentCryptocurrencyDetailViewController__cryptocurrency(Parameter<Cryptocurrency>.value(`cryptocurrency`))) as? (Cryptocurrency) -> Void
    ...
    fileprivate enum MethodType {
        ...
        case m_presentCryptocurrencyDetailViewController__cryptocurrency(Parameter<Cryptocurrency>)
        ...
        static func compareParameters(lhs: MethodType, rhs: MethodType, matcher: Matcher) -> Matcher.ComparisonResult {
            ...
            case (.m_presentCryptocurrencyDetailViewController__cryptocurrency(let lhsCryptocurrency), .m_presentCryptocurrencyDetailViewController__cryptocurrency(let rhsCryptocurrency)):
				var results: [Matcher.ParameterComparisonResult] = []
        ...
        func intValue() -> Int {
            ...
            case let .m_presentCryptocurrencyDetailViewController__cryptocurrency(p0): return p0.intValue
            }
        }
        func assertionName() -> String {
            switch self {
            ...
            case .m_presentCryptocurrencyDetailViewController__cryptocurrency: return ".presentCryptocurrencyDetailViewController(_:)"
            }
        }
    }
    ...
    public struct Verify {
        ...
        public static func presentCryptocurrencyDetailViewController(_ cryptocurrency: Parameter<Cryptocurrency>) -> Verify { return Verify(method: .m_presentCryptocurrencyDetailViewController__cryptocurrency(`cryptocurrency`))}
    }
    ...
    public struct Perform {
        ...
        public static func presentCryptocurrencyDetailViewController(_ cryptocurrency: Parameter<Cryptocurrency>, perform: @escaping (Cryptocurrency) -> Void) -> Perform {
            return Perform(method: .m_presentCryptocurrencyDetailViewController__cryptocurrency(`cryptocurrency`), performs: perform)
        }
    }
