...
@available(*, deprecated, message: "To be replaced by PromiseKit")
...
@available(*, deprecated, message: "To be replaced by the new DefaultRequestSender")
public class DefaultDeprecatedRequestSender: DeprecatedURLRequestSender {
